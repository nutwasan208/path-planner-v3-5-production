...
const files=['public/index.html','public/dashboard.html','public/css/dashboard.css','public/js/cloud-service.js','public/js/dashboard-service.js','public/js/dashboard.js','supabase/production_hardening.sql','netlify.toml'];
...
for(const token of ['studentClassSelect','studentNumberInput','CloudService.startSession','CloudService.recordLevel','dashboard.html','btnTeacherDashboard'])if(!index.includes(token))throw new Error(`Missing game integration token: ${token}`);
